...
st.snow()
st.header("ForexLIT - CONVERTER")
st.sidebar.warning("Convert 💱 Currencies with latest exchange rates in realtime")
...
from_cur = st.selectbox("FROM", currency)
to_cur = st.selectbox("TO", currency)

get_exchange(from_cur, to_cur)
